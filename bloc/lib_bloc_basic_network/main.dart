...
extension LoadPageExt on PPBloc {
  ...
  void _loadPage(int offset, {bool force = true}) {
    var listURL =
        "https://programtom.com/Portfolio_Platform/publicDATA/profile/indexJsonExt.php";
    var uri = Uri.parse(listURL + "?limit="+PPBloc.LIMIT.toString()+"&offset=" + offset.toString());
